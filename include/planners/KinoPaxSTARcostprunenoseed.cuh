...
class KinoPaxSTARcostprunenoseed : public Planner
{
public:
    /**************************** CONSTRUCTORS ****************************/
    KinoPaxSTARcostprunenoseed();
    ~KinoPaxSTARcostprunenoseed();
    ...
    float h_pSeed_;           // R2 sub-region seeding probability: 0 = off (noseed), 1 = stock costprune (set in ctor)
