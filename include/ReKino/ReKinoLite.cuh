 ...
 *
 * Each warp (32 threads) maintains ONE path cooperatively:
 ...
 * - Repeat until goal found or max iterations (with 6-second hard timeout)
 *
 ...
 *
 * Each warp (32 threads) collaborates to extend one path:
