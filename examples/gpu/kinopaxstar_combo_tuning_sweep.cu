...
struct IterationData
{
    ...
    // as the tree buffer fills, rep_target should fall to 1, and prop_attempted /
    // frontier_repeat_size should read exactly 32 for as long as the kernel1 invariant holds.
