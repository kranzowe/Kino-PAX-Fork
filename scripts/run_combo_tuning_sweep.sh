...
echo "  COMBO:          N {0,0.5,1.0,1.5,2.0} sigma x kFan {0,1,4,16} x rf 0.1 = 17 points"
...
echo "                  (CleanCost/KinoPaxPlus behaviour); N 0 puts the threshold at the mean,"
echo "                  which is the first fan-out rule's failure mode, kept reproducible."
