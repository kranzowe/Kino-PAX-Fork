#!/bin/bash
# =============================================================================
# KinoPaxSTAR Large-Delta Benchmark Runner
#
# Single-delta variant of run_delta_benchmark.sh: builds ONE config (the Large
# delta) and runs the KinoPaxStarLargeBenchmark once, which executes all 7
# planners (KPAX, PruneKPAX, KinoPaxPlus, KinoPaxSTARNoPrune, KinoPaxSTAR,
# KinoPaxSTARcostprune, KinoPaxSTARNoPruneNoSpatialHash) 5x each on the House
# environment.
#
...
#
# Usage:
#   cd scripts && bash run_large_benchmark.sh
# =============================================================================
set -euo pipefail
...
echo ""
echo "======================================================="
echo "  KinoPaxSTAR Large-Delta Benchmark"
...
echo "  Planners: all 7 (KPAX, PruneKPAX, KinoPaxPlus, KinoPaxSTARNoPrune,"
echo "            KinoPaxSTAR, KinoPaxSTARcostprune, KinoPaxSTARNoPruneNoSpatialHash)"
echo "======================================================="
...
make KinoPaxStarLargeBenchmark -j"$(nproc)" 2>&1 | tail -20
cd "$PROJECT_DIR"

# =============================================================================
# RUN — execute the benchmark (all 7 planners, single delta, single env)
# =============================================================================
echo ""
