...
%
% csExploreFracs* ARE round(1000 x frac) TOKENS, not 100x -- see countingStarsLabel() in the
% benchmark. The 1000x convention arrived when the grid reached 0.001 (which rounds to 0 at 100x)
