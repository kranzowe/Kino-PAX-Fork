...
plannerNames  = {'KinoPaxPlus', 'KinoPaxSTAR', 'KinoPaxSTARcostprune', 'KinoPaxSTARNoPrune', 'KPAX', 'PruneKPAX'};
...
plannerStyles = {'-', '-', '-', '-', '-', '-'};
numRunsPer    = [50, 50, 50, 50, 50, 50];   % max runs searched per planner (missing files skipped)
